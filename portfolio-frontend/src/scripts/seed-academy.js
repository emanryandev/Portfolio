...
const project = {
  ...
  slug: 'academy',
  client_name: 'Academy',
  summary: 'An integrated Learning Management System (LMS) built with Laravel for managing courses, sessions, and students.',
  description: `# 🎓 Academy — Comprehensive Project Documentation
...
\`\`\`
`,
  image_url: null, // I will let the user upload the image from Admin dashboard or we can just leave it empty for now
  live_url: 'http://127.0.0.1:8000',
  github_url: null,
  technologies: ['PHP 8.3', 'Laravel 13.8', 'MySQL', 'TailwindCSS 4.0', 'Alpine.js', 'Docker'],
  is_featured: true,
...
async function run() {
  ...
  console.log('Added Academy project successfully!');
}
